window.addEventListener('message', async e => {
  ...
  (() => {
      ...
      let rewind_tooltipText = 'Atrasar 10s';
      ...
      function download_ButtonClickAction() {
          ...
          if (!didDownload) {
              didDownload = true;
              console.log('[CR Premium] Descargando fuentes:');
  ...
  function updateWebVideoCasterAnchor() {
      ...
      console.log(`[CR Premium] Definió el WVC como un ${r[quality]}p`);
  ...
  function getSourceLocale() {
      try {
          ...
          displayError(`Las cookies ${linkIssue('estan desactivadas')}!</code>`);
          throw err;
      }
  }
